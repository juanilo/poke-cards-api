...
exports.weaknessTo =
  exports.resistancesTo =
  exports.battle =
  exports.remove =
  exports.update =
  exports.create =
  exports.findAllNames =
  exports.findById =
  exports.findAll =
    void 0;
const database_1 = require('../database/database');
const findAll = (limit, page, filter) =>
...
const create = (cardData) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = yield database_1.connection.query(
      'INSERT INTO cards (\
                    name, \
                    type, \
                    image_url, \
...
const resistancesTo = (card) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const resistance = card.resistance.type;
    return yield database_1.connection.query(
      `SELECT * FROM cards WHERE attacks @> '[{"abilities": [{"type": "$1"}]}]'`,
      [resistance],
    );
  });
exports.resistancesTo = resistancesTo;
const weaknessTo = (card) =>
  __awaiter(void 0, void 0, void 0, function* () {
